...
export DEV_PREFIX=$HOME/git/sctpwithjava/jni-src
...
export PREFIX=${DEV_PREFIX}/android_build/
...
export CFLAGS="${CFLAGS} --sysroot=${SYSROOT} -I${SYSROOT}/usr/include -I${ANDROID_PREFIX}/include -Ofast -fPIE -pie"
